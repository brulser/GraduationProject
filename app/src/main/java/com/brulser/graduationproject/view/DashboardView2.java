...
public class DashboardView2 extends View {
    ...
    private String mHeaderText = "空气质量"; // 表头
    ...
    private void init() {
        ...
        mTexts = new String[]{"0", "优", "75", "良", "125", "轻污染", "175", "中污染", "250", "重污染", "300"};
...
//        mTexts = new String[]{"350", "较差", "550", "中等", "600", "良好", "650", "优秀", "700", "极好", "950"};
        ...
        if (value > 250) {
            return 8 * degreePerSection + 2 * degreePerSection / 50 * (value - 250);
        } else if (value > 175) {
            return 6 * degreePerSection + 2 * degreePerSection / 75 * (value - 175);
        } else if (value > 125) {
            return 4 * degreePerSection + 2 * degreePerSection / 50 * (value - 125);
        } else if (value > 75) {
            return 2 * degreePerSection + 2 * degreePerSection / 75 * (value - 75);
        } else {
    ...
    private String calculateCreditDescription() {
        ...
        if (mSolidCreditValue > 250) {
            return "重度污染";
        } else if (mSolidCreditValue > 175) {
            return "中度污染";
        } else if (mSolidCreditValue > 125) {
            return "轻度污染";
        } else if (mSolidCreditValue > 75) {
            return "良";
        }
        return "优";
    }
